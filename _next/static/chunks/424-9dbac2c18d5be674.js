    ...
    [424], {
                ...
                a = (e, r) => {
                    let t = (0, o.forwardRef)((t, s) => {
                        ...
                        return (0, o.createElement)(i, {
                            ref: s,
                            iconNode: r,
                            className: l("lucide-".concat(n(e)), a),
                            ...d
                        })
                    });
        ...
        6992: (e, r, t) => {
            ...
            let n = e => "boolean" == typeof e ? `${e}` : 0 === e ? "0" : e,
                ...
                s = (e, r) => t => {
                    ...
                    return l(e, a, null == r ? void 0 : null === (o = r.compoundVariants) || void 0 === o ? void 0 : o.reduce((e, r) => {
                        let {
                            class: t,
                            className: o,
                            ...n
        ...
        8441: (e, r, t) => {
            ...
            function y() {
                let e, r, t = 0,
                    o = "";
                for (; t < arguments.length;)(e = arguments[t++]) && (r = v(e)) && (o && (o += " "), o += r);
                return o
            }
            let v = e => {
                    let r;
                    ...
                    let t = "";
                    for (let o = 0; o < e.length; o++) e[o] && (r = v(e[o])) && (t && (t += " "), t += r);
                    return t
                },
                x = e => {
                    let r = r => r[e] || [];
            ...
            let H = function(e, ...r) {
                let t, o, n;
                let l = function(i) {
                    return o = (t = m(r.reduce((e, r) => r(e), e()))).cache.get, n = t.cache.set, l = s, s(i)
                };
                ...
                let r = function(e) {
                        let r = o.forwardRef((e, r) => {
                            ...
                            if (o.isValidElement(t)) {
                                var s;
                                let e, i;
                                let a = (s = t, (i = (e = Object.getOwnPropertyDescriptor(s.props, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? s.ref : (i = (e = Object.getOwnPropertyDescriptor(s, "ref") ? .get) && "isReactWarning" in e && e.isReactWarning) ? s.props.ref : s.props.ref || s.ref),
                                    d = function(e, r) {
                                        let t = { ...r
                                        };
                                        for (let o in r) {
                                ...
                                return t.type !== o.Fragment && (d.ref = r ? (0, n.t)(r, a) : a), o.cloneElement(t, d)
                            }
                    ...
                    t = o.forwardRef((e, t) => {
                        let {
                            children: n,
                            ...s
                        } = e, i = o.Children.toArray(n), a = i.find(d);
                        if (a) {
